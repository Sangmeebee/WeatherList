...
internal class WeatherRemoteDatasourceImpl @Inject constructor(
    ...
    override suspend fun getWeather(latitude: Double, longitude: Double, appId: String): Result<WeatherEntity> = runCatching {
        withContext(ioDispatcher) {
            weatherAPI.getWeather(latitude, longitude, appId).toData()
        }
    }
}
